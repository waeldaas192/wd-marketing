...

{
  ...
  "id": "cvt_WDConsent",
  "version": 1,
  "displayName": "WD Marketing - consent",
      ...
      "param": [
        {
          ...
          "value": {
            ...
            "listItem": [
              ...
              {
                "type": 1,
                "string": "allow_google_signals"
              },
              {
                "type": 1,
                "string": "allow_ad_personalization_signals"
              },
              {
                "type": 1,
                "string": "send_page_view"
              },
              {
                "type": 1,
