...
export default function RootLayout({children}:{children:ReactNode}){
  return <html lang="en" data-scroll-behavior="smooth" className={inter.variable}><body><a href="#main-content" className="skip-link">Skip to content</a><JsonLd value={rootStructuredData()}/><Header/><main id="main-content" tabIndex={-1}>{children}</main><Footer/><PageMotion/><CookieConsent/></body></html>;
}
