...
export default function RootLayout({children}:{children:ReactNode}){
  ...
  return <html lang="en" data-scroll-behavior="smooth" className={inter.variable}><body><a href="#main-content" className="skip-link">Skip to content</a><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(schema).replace(/</g,"\\u003c")}}/><div className="site-squares" aria-hidden="true"><i/><i/><i/><i/><i/><i/></div><Header/><main id="main-content" tabIndex={-1}>{children}</main><Footer/><PageMotion/></body></html>;
}
