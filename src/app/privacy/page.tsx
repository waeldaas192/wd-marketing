...
export default function Privacy() {
  return <LegalPage title="Privacy policy" intro="This policy explains how we handle personal information when you visit wdmarketing.co.uk, send a project enquiry or contact us about our services.">
    ...
    <p>{legal.tradingIdentity} operates as a sole trader and is the controller responsible for deciding how information collected through this website is used. For privacy questions or requests, email <a href={"mailto:" + legal.email}>{legal.email}</a>. Our contact details appear below.</p>
