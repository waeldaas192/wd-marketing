...
export default function SeoPage() {
  return (
    <div className={styles.page}>
      ...
      <section className={styles.perspective} aria-labelledby="local-seo-link-title"><div className={`container ${styles.perspectiveGrid}`}><div><p className={styles.eyebrow}>Local search</p><h2 id="local-seo-link-title">Need to win more<br /><span>local London searches?</span></h2></div><div><p>For businesses where service area and proximity influence the buying decision, our dedicated Local SEO London service connects Google Business Profile, service pages, location strategy and enquiry tracking.</p><Link className={styles.textLink} href="/services/local-seo-london">Explore Local SEO London <Arrow diagonal /></Link></div></div></section>
