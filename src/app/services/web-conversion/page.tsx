...
export default function Page() {
  return <><JsonLd value={serviceStructuredData({ name: "Web Design & Conversion", description, pathname: "/services/web-conversion", serviceType: "Web design and development" })} /><Breadcrumbs items={[{ label: "Services", href: "/services" }, { label: "Web & Conversion", href: "/services/web-conversion" }]} /><ServicePage data={webPageData} /></>;
}
