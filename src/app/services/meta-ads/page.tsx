...
export default function MetaAdsPage() {
  return <>
    ...
    <div className={styles.page}>
      ...
      <section className={styles.connected} aria-labelledby="connected-title"><div className="container"><div><p>ONE SYSTEM. ONE COMMERCIAL VIEW.</p><h2 id="connected-title">Paid social works better when the website, conversion journey, tracking and CRM are part of the conversation.</h2></div><div className={styles.connectedLinks}><Link href="/services/paid-acquisition"><span>01</span><strong>Google Ads & Paid Acquisition</strong><Arrow /></Link><Link href="/services/conversion-rate-optimisation"><span>02</span><strong>Conversion Rate Optimisation</strong><Arrow /></Link><Link href="/services/growth-infrastructure"><span>03</span><strong>HighLevel, GA4, GTM & CRM</strong><Arrow /></Link><Link href="/services/web-conversion"><span>04</span><strong>Landing Pages & Conversion</strong><Arrow /></Link></div></div></section>
