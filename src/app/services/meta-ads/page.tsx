...
export default function MetaAdsPage() {
  return <>
    ...
    <div className={styles.page}>
      ...
      </div><p className={styles.disclaimer}>Campaign figures are historical Meta Ads Manager metrics supplied from the relevant advertising accounts. They describe those campaigns only and are not a forecast or guarantee for another advertiser.</p></div></section>
