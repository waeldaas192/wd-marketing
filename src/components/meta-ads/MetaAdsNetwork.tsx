...
export function MetaAdsNetwork() {
  return <div className={styles.shell} role="img" aria-label="WD Marketing connecting Meta Ads, Facebook, Instagram, HighLevel CRM, leads, calls, messages, sales pipeline and growth">
    ...
    <div className={styles.network}>
      ...
      <div className={styles.center} aria-hidden="true"><span className={styles.logoWrap}><Image src="/images/brand/wd-marketing-ribbon-mark.png" alt="WD Marketing" width={144} height={72}/></span><strong>WD Marketing</strong><small>Connected acquisition system</small></div>
