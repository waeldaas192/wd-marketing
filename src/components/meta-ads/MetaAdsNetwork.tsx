...
function MetaIcon() {
  return <svg data-meta-brand-icon="meta" className={styles.brandSvg} viewBox="0 0 24 24" aria-hidden="true"><path d={META_PATH}/></svg>;
}
function FacebookIcon() {
  return <svg data-meta-brand-icon="facebook" className={styles.brandSvg} viewBox="0 0 24 24" aria-hidden="true"><path d={FACEBOOK_PATH}/></svg>;
}
function InstagramIcon() {
  return <svg data-meta-brand-icon="instagram" className={styles.brandSvg} viewBox="0 0 24 24" aria-hidden="true"><defs><linearGradient id="instagram-orbit-brand" x1="2" x2="22" y1="22" y2="2" gradientUnits="userSpaceOnUse"><stop stopColor="#FEDA75"/><stop offset=".28" stopColor="#FA7E1E"/><stop offset=".52" stopColor="#D62976"/><stop offset=".75" stopColor="#962FBF"/><stop offset="1" stopColor="#4F5BD5"/></linearGradient></defs><path d={INSTAGRAM_PATH} fill="url(#instagram-orbit-brand)"/></svg>;
}
  ...
  return (
    <div className={styles.shell} data-meta-network role="img" aria-label="WD Marketing at the centre of a connected Meta advertising ecosystem">
      ...
      <div className={styles.stage}>
        ...
        <div data-meta-orbit="inner" className={[styles.orbit, styles.innerOrbit].join(" ")} aria-hidden="true">
          {innerBrands.map((brand) => <OrbitItem key={brand.name} brand={brand}/>)}
        </div>

        <div data-meta-orbit="outer" className={[styles.orbit, styles.outerOrbit].join(" ")} aria-hidden="true">
