...
export function Footer() {
  return <footer className={styles.footer}><div className="container">
    <div className={styles.top}><h2 className={styles.title}>Make the next move.<span>Make it count.</span></h2><Link href="/contact" className={styles.arrow} aria-label="Start a project">↗</Link></div>
