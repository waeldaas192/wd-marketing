...
const assets = [
  ...
  ['/images/projects/roofing/mb-legacy-roofing-responsive-website.webp', 1800, 1200],
];
...
async function main() {
  ...
  assert(html.includes('data-roofing-approach="true"'), 'Case study must include the analysis and strategy narrative');
  ...
  console.log('PASS MB Legacy case study: verified metrics, coded platform, strategy narrative and two optimised assets.');
}
