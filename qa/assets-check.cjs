...
for(const file of ['/images/brand/wd-marketing-ribbon-mark.png','/images/brand/wd-marketing-favicon.png'])items.push({file,status:fs.existsSync(path.join(process.cwd(),'public',file))?'present':'missing',kb:0,optional:false});
